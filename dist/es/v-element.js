...
import { defineComponent as F, computed as k, openBlock as p, createElementBlock as $, mergeProps as oe, createVNode as C, unref as R, normalizeProps as bn, guardReactiveProps as $n, ref as w, normalizeClass as L, createBlock as U, createCommentVNode as E, createElementVNode as j, renderSlot as P, watch as H, provide as ze, inject as Ue, toDisplayString as fe, Transition as He, toHandlers as Ve, withCtx as ne, withDirectives as ke, vShow as Vt, onMounted as ve, onUnmounted as Ge, reactive as Ie, createTextVNode as Mt, Fragment as Ke, useAttrs as Tn, vModelDynamic as _n, withModifiers as se, vModelText as wn, nextTick as Nt, shallowReactive as On, h as xn, render as it, isRef as kn, onBeforeUnmount as In, normalizeStyle as Sn, renderList as jn, withKeys as An } from "vue";
...
var Dt = typeof global == "object" && global && global.Object === Object && global, Bn = typeof self == "object" && self && self.Object === Object && self, N = Dt || Bn || Function("return this")(), z = N.Symbol, Lt = Object.prototype, Fn = Lt.hasOwnProperty, Vn = Lt.toString, le = z ? z.toStringTag : void 0;
function Mn(e) {
...
function Gt(e, t, n) {
  var r = e[t];
  (!(Er.call(e, t) && Ht(r, n)) || n === void 0 && !(t in e)) && Ut(e, t, n);
}
function ge(e, t, n, r) {
  var o = !n;
  n || (n = {});
  for (var l = -1, i = t.length; ++l < i; ) {
    ...
    s === void 0 && (s = e[a]), o ? Ut(n, a, s) : Gt(n, a, s);
  }
  return n;
}
var ht = Math.max;
...
function Wt(e) {
  return e != null && Kt(e.length) && !Se(e);
}
...
var qt = Object.prototype, Nr = qt.hasOwnProperty, Dr = qt.propertyIsEnumerable, Zt = vt(/* @__PURE__ */ function() {
  return arguments;
}()) ? vt : function(e) {
...
var Xt = typeof exports == "object" && exports && !exports.nodeType && exports, gt = Xt && typeof module == "object" && module && !module.nodeType && module, Rr = gt && gt.exports === Xt, mt = Rr ? N.Buffer : void 0, zr = mt ? mt.isBuffer : void 0, Yt = zr || Lr, Ur = "[object Arguments]", Hr = "[object Array]", Gr = "[object Boolean]", Kr = "[object Date]", Wr = "[object Error]", qr = "[object Function]", Zr = "[object Map]", Xr = "[object Number]", Yr = "[object Object]", Jr = "[object RegExp]", Qr = "[object Set]", eo = "[object String]", to = "[object WeakMap]", no = "[object ArrayBuffer]", ro = "[object DataView]", oo = "[object Float32Array]", ao = "[object Float64Array]", io = "[object Int8Array]", lo = "[object Int16Array]", so = "[object Int32Array]", uo = "[object Uint8Array]", co = "[object Uint8ClampedArray]", fo = "[object Uint16Array]", po = "[object Uint32Array]", b = {};
...
var Jt = typeof exports == "object" && exports && !exports.nodeType && exports, ue = Jt && typeof module == "object" && module && !module.nodeType && module, vo = ue && ue.exports === Jt, Be = vo && Dt.process, ae = function() {
  try {
...
function Qt(e, t) {
  var n = Q(e), r = !n && Zt(e), o = !n && !r && Yt(e), l = !n && !r && !o && go(e), i = n || r || o || l, a = i ? Vr(e.length, String) : [], s = a.length;
  for (var u in e)
...
var bo = en(Object.keys, Object), $o = Object.prototype, To = $o.hasOwnProperty;
function _o(e) {
  if (!We(e))
    return bo(e);
  var t = [];
...
function ua(e) {
  return Q(e) || Zt(e) || !!(bt && e && e[bt]);
}
function nn(e, t, n, r, o) {
  var l = -1, i = e.length;
  for (n || (n = ua), o || (o = []); ++l < i; ) {
    var a = e[l];
    t > 0 && n(a) ? t > 1 ? nn(a, t - 1, n, r, o) : Qe(o, a) : r || (o[o.length] = a);
  }
  return o;
}
function ca(e) {
...
var et = en(Object.getPrototypeOf, Object), fa = "[object Object]", pa = Function.prototype, ha = Object.prototype, rn = pa.toString, va = ha.hasOwnProperty, ga = rn.call(Object);
function ma(e) {
  if (!J(e) || Y(e) != fa)
    return !1;
  var t = et(e);
  ...
  return typeof n == "function" && n instanceof n && rn.call(n) == ga;
}
function ya(e, t, n) {
  var r = -1, o = e.length;
...
var on = typeof exports == "object" && exports && !exports.nodeType && exports, $t = on && typeof module == "object" && module && !module.nodeType && module, Ia = $t && $t.exports === on, Tt = Ia ? N.Buffer : void 0, _t = Tt ? Tt.allocUnsafe : void 0;
function Sa(e, t) {
  if (t)
    return e.slice();
...
var Aa = Object.prototype, Ca = Aa.propertyIsEnumerable, wt = Object.getOwnPropertySymbols, tt = wt ? function(e) {
  return e == null ? [] : (e = Object(e), ja(wt(e), function(t) {
    return Ca.call(e, t);
  }));
} : an;
function Ea(e, t) {
...
var Pt = ae && ae.isSet, wi = Pt ? qe(Pt) : _i, Oi = 1, xi = 2, ki = 4, cn = "[object Arguments]", Ii = "[object Array]", Si = "[object Boolean]", ji = "[object Date]", Ai = "[object Error]", dn = "[object Function]", Ci = "[object GeneratorFunction]", Ei = "[object Map]", Pi = "[object Number]", fn = "[object Object]", Bi = "[object RegExp]", Fi = "[object Set]", Vi = "[object String]", Mi = "[object Symbol]", Ni = "[object WeakMap]", Di = "[object ArrayBuffer]", Li = "[object DataView]", Ri = "[object Float32Array]", zi = "[object Float64Array]", Ui = "[object Int8Array]", Hi = "[object Int16Array]", Gi = "[object Int32Array]", Ki = "[object Uint8Array]", Wi = "[object Uint8ClampedArray]", qi = "[object Uint16Array]", Zi = "[object Uint32Array]", y = {};
y[cn] = y[Ii] = y[Di] = y[Li] = y[Si] = y[ji] = y[Ri] = y[zi] = y[Ui] = y[Hi] = y[Gi] = y[Ei] = y[Pi] = y[fn] = y[Bi] = y[Fi] = y[Vi] = y[Mi] = y[Ki] = y[Wi] = y[qi] = y[Zi] = !0;
y[Ai] = y[dn] = y[Ni] = !1;
function me(e, t, n, r, o, l) {
  ...
  if (x)
    return x;
  l.set(e, i), wi(e) ? e.forEach(function(g) {
    i.add(me(g, t, n, g, e, l));
  }) : $i(e) && e.forEach(function(g, h) {
    i.set(h, me(g, t, n, h, e, l));
  });
  var v = u ? s ? un : Va : s ? Xe : Ze, O = d ? void 0 : v(e);
  return Ir(O || e, function(g, h) {
    O && (h = g, g = e[h]), Gt(i, h, me(g, t, n, h, e, l));
  }), i;
}
var Fe = function() {
  return N.Date.now();
...
function Re(e, t, n) {
  ...
  function v(m) {
    return u = m, a = setTimeout(h, t), d ? x(m) : i;
  }
  function O(m) {
    var V = m - s, c = m - u, _ = t - V;
    return f ? Ji(_, l - c) : _;
  }
  function g(m) {
    var V = m - s, c = m - u;
  ...
  function A() {
    ...
    if (r = arguments, o = this, s = m, V) {
      if (a === void 0)
        return v(s);
      if (f)
        return clearTimeout(a), a = setTimeout(h, t), x(s);
    }
...
function tl(e, t) {
  return t = Je(t, e), e = el(e, t), e == null || delete e[tn(Qi(t))];
}
function nl(e) {
...
var rl = 1, ol = 2, al = 4, il = da(function(e, t) {
  ...
  }), ge(e, un(e), n), r && (n = me(n, rl | ol | al, nl));
...
const pn = Symbol("collapseContext"), sl = { class: "vk-collapse" }, be = /* @__PURE__ */ F({
  name: "VkCollapse",
  __name: "Collapse",
  props: {
    modelValue: null,
  ...
  setup(e) {
    const t = e, n = Ue(pn), r = k(() => n == null ? void 0 : n.activeNames.value.includes(t.name)), o = () => {
...
const fl = (e, t) => {
  ...
  setup(e, { expose: t, emit: n }) {
    const r = e, o = n, l = w(!1), i = w(), a = w(), s = w();
    ...
    const O = Re(x, r.openDelay), g = Re(v, r.closeDelay);
    function h() {
      g.cancel(), O();
    }
    function I() {
    ...
    function D() {
      r.trigger === "hover" ? (d.mouseenter = h, f.mouseleave = I) : r.trigger === "click" && (d.click = M);
    }
    return r.manual || D(), H(
      () => r.manual,
      (A) => {
...
const hn = Symbol("formContextKey"), vn = Symbol("formItemContextKey"), hl = { class: "vk-form" }, _e = /* @__PURE__ */ F({
  name: "VkForm",
  __name: "Form",
  props: {
    model: null,
  ...
  setup(e, { expose: t }) {
    ...
    const i = k(() => {
      ...
      return v && n.prop && !Bt(v[n.prop]) ? v[n.prop] : null;
    }), a = k(() => {
      const v = r == null ? void 0 : r.rules;
      return v && n.prop && v[n.prop] ? v[n.prop] : [];
    });
    function s(v) {
      const O = a.value;
      return O ? O.filter((g) => !g.trigger || !v ? !0 : g.trigger && g.trigger === v) : [];
    }
    const u = k(() => a.value.some((v) => v.required));
    async function d(v) {
      const O = n.prop, g = s(v);
      if (g.length === 0)
      ...
      if (O) {
        ...
        return o.loading = !0, h.validate({ [O]: i.value }).then(() => {
          o.state = "success";
        }).catch((I) => {
          const { errors: M } = I;
    ...
    const f = () => {
      ...
      f();
      const v = r == null ? void 0 : r.model;
      v && n.prop && !Bt(v[n.prop]) && (v[n.prop] = l);
    }, x = {
      validate: d,
      prop: n.prop || "",
      clearValidate: f,
    ...
    return ze(vn, x), ve(() => {
      ...
      j("label", vl, [
        P(v.$slots, "label", { label: e.label }, () => [
          Mt(fe(e.label), 1)
        ])
      ]),
      j("div", gl, [
        P(v.$slots, "default", { validate: d }),
        o.state === "error" ? (p(), $("div", ml, fe(o.errorMsg), 1)) : E("", !0)
      ])
    ], 2));
  }
});
...
const yl = {
...
}, Tl = ["type", "disabled", "readonly", "autocomplete", "placeholder", "autofocus", "form"], _l = {
  key: 1,
  class: "vk-input__append"
}, wl = ["disabled", "readonly", "autocomplete", "placeholder", "autofocus", "form"], ce = /* @__PURE__ */ F({
  name: "VkInput",
  inheritAttrs: !1,
  __name: "Input",
  props: {
  ...
  setup(e, { expose: t, emit: n }) {
    const r = Ue(vn), o = Tn(), l = e, i = n, a = w(), s = w(l.modelValue);
    H(
      () => l.modelValue,
      (c) => {
        s.value = c;
    ...
    const u = w(!1), d = w(!1), f = k(() => !!(!l.disabled && l.clearable && d.value && s.value || !l.disabled && l.clearable && u.value && s.value)), T = w(!1);
    function x() {
      T.value = !T.value;
    }
    function v() {
    ...
    return t({
      ...
      e.type !== "textarea" ? (p(), $(Ke, { key: 0 }, [
        c.$slots.prepend ? (p(), $("div", yl, [
          P(c.$slots, "prepend")
        ])) : E("", !0),
        j("div", bl, [
          c.$slots.prefix ? (p(), $("span", $l, [
            P(c.$slots, "prefix")
          ])) : E("", !0),
          ke(j("input", oe({
            "onUpdate:modelValue": _[0] || (_[0] = (S) => s.value = S),
            ref_key: "inputRef",
            ref: a
          }, R(o), {
          ...
          c.$slots.suffix || u.value ? (p(), $("span", {
            key: 1,
            class: "vk-input__suffix",
            onClick: M
          }, [
            l.type === "password" && !T.value ? (p(), U(B, {
              key: 0,
              icon: "eye",
...
}), gn = Ol, Ft = w(0), xl = (e = 2e3) => {
  const t = w(e), n = k(() => Ft.value + t.value);
  return {
    initialZIndex: t,
    currentZIndex: n,
...
const Cl = { class: "vk-message_content" }, El = {
  ...
  setup(e, { expose: t }) {
    const n = e, r = w(!1), o = w(), l = w(0), i = k(() => Sl(n.id)), a = k(() => n.offset + i.value), s = k(() => l.value + a.value), u = k(() => ({
      top: a.value + "px",
      zIndex: n.zIndex
    }));
    let d;
    ...
    ve(async () => {
      r.value = !0, f(), await Nt(), l.value = o.value.getBoundingClientRect().height;
    }), Al(document, "keydown", (h) => {
...
const Pl = {
  ...
  setup(e, { emit: t }) {
    const n = e, r = t, o = f(n.modelValue), l = w(), i = w(), a = Ie({
    ...
    function f(c) {
      const _ = n.options.find((S) => S.value === c);
      return _ || null;
    }
    async function T(c) {
      if (n.filterable) {
        if (n.filterMethod && Se(n.filterMethod))
          ...
          try {
            ...
            console.error(_), d.value = [];
          } finally {
            a.loading = !1;
          }
        } else
          d.value = n.options.filter((_) => _.label.includes(c));
        a.highlightIndex = -1;
      }
    }
    function x() {
    ...
    const v = k(() => n.remote ? 300 : 0), O = Re(() => {
      x();
    }, v.value), g = k(() => n.filterable && a.selectedOption && s.value ? a.selectedOption.label : n.placeholder);
    function h(c) {
    ...
    function I(c) {
      switch (c.key) {
        case "Enter":
          s.value ? a.highlightIndex > -1 && d.value[a.highlightIndex] ? m(d.value[a.highlightIndex]) : h(!1) : h(!0);
          break;
        case "Escape":
          s.value && h(!1);
          break;
    ...
    function A() {
      n.disabled || (s.value ? h(!1) : h(!0));
    }
    function m(c) {
      c.disabled || (a.inputValue = c.label, a.selectedOption = c, r("change", c.value), r("update:modelValue", c.value), h(!1), i.value.ref.focus());
    }
    function V() {
    }
    return (c, _) => (p(), $("div", {
      ...
      onClick: A,
      onMouseenter: _[2] || (_[2] = (S) => a.mouseHover = !0),
      onMouseleave: _[3] || (_[3] = (S) => a.mouseHover = !1)
    }, [
      C(re, {
        ...
        content: ne(() => [
          ...
          ])) : e.filterable && d.value.length === 0 ? (p(), $("div", Bl, " no matching data ")) : (p(), $("ul", Fl, [
            (p(!0), $(Ke, null, jn(d.value, (S, ot) => {
              var at;
              return p(), $("li", {
                key: ot,
        ...
        default: ne(() => [
          C(ce, {
            ...
            "onUpdate:modelValue": _[0] || (_[0] = (S) => a.inputValue = S),
            disabled: e.disabled,
            placeholder: g.value,
            ref_key: "inputRef",
            ref: i,
...
const Ml = ["name", "disabled"], Nl = { class: "vk-switch__core" }, Dl = { class: "vk-switch__core-inner" }, Ll = {
  ...
  setup(e, { emit: t }) {
    const n = e, r = t, o = w(), l = w(n.modelValue), i = k(() => l.value === n.activeValue);
    function a() {
      if (n.disabled)
        return;
    ...
    return H(i, (s) => {
      ...
      j("div", Nl, [
        j("div", Dl, [
          e.activeText || e.inactiveText ? (p(), $("span", Ll, fe(i.value ? e.activeText : e.inactiveText), 1)) : E("", !0)
        ]),
        Rl
      ])
    ], 2));
